...
//    public static final String BASEURL = "http://192.168.0.225/";
    ...
    public static final String FBID = "facebook_id";
    ...
    public static final String GAMEORDERID = "game_order_no";
    public static final String GOOGLEORDERID = "google_order_no";
    public static final String PACKAGENAME = "package_name";
    public static final String GOOGLEPURCHASETOKEN = "purchase_token";
    ...
    public static final String FBTYPE = "facebook";
    public static final String GOOGLETYPE = "google";
    public static final String GUSETTYPE = "guest";
